...
export default function Home() {
    ...
    const dummyInterviews: Interview[] = [
        {
            ...
            short_description: "An in-depth breakdown of the 4-round interview for a Software Engineer role at Google.",
            isVerified: true,
            duration: 45,
        ...
        },
        {
            ...
            short_description: "Detailed experience of Microsoft's PM internship process with virtual rounds and a final behavioral interview.",
            isVerified: true,
            duration: 30,
        ...
        },
        {
            ...
            short_description: "React-heavy coding round followed by a system design interview for a UI-heavy role.",
            isVerified: true,
            duration: 40,
        ...
        },
        {
            ...
            short_description: "A smooth intern interview process with one OA and one technical interview with a hiring manager.",
            isVerified: true,
            duration: 25,
        ...
        },
        {
            ...
            short_description: "A rigorous interview involving math, coding, and research problem-solving.",
            isVerified: true,
            duration: 70,
    ...
    const completedInterviews: Interview[] = [
        ...
        },
        {
            ...
            short_description: "Hands-on full stack interview including React, Node.js and a small design challenge.",
            isVerified: true,
            duration: 50,
            totalApplications: 4,
            kind: "Full Stack",
